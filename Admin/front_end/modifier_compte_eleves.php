...
require ('..\back_end\id_verif_admin_eleves.php');
?>
<html>
        <head>
        ...
        ?>
        <body>
            <form action="../back_end/post_modifier_compte_eleves.php?id=<?= $_GET['id'] ?? '' ?>" method="post" class="form">
                <div class="row">
                    <div class="col-2"></div>
                    ...
                    <div class="form col-3">
                        ...
                        $texte_chiffre = hex2bin($article['emel_chiffr']);
